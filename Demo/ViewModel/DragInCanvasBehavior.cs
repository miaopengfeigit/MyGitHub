...
namespace MvvmLight1.ViewModel
{
    ...
    //    {
    //        var someone = VisualTreeHelper.GetParent(this.AssociatedObject);
    //        // Find the canvas. 
    //        if (canvas == null) canvas = VisualTreeHelper.GetParent(someone) as Canvas;
    ...
    //            // Move the element. 
    //            VisualTreeHelper.GetParent(this.AssociatedObject).SetValue(Canvas.TopProperty, point.Y - mouseOffset.Y);
    //            VisualTreeHelper.GetParent(this.AssociatedObject).SetValue(Canvas.LeftProperty, point.X - mouseOffset.X);
