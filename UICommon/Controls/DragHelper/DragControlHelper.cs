...
namespace UICommon.Controls
{
    public class DragControlHelper : DragHelperBase
    {
        ...
        #region IsRect
        public static Rect GetIsRect(DependencyObject obj)
        {
            return (Rect)obj.GetValue(IsRectProperty);
        }

        public static void SetIsRect(DependencyObject obj, Rect value)
        {
            obj.SetValue(IsRectProperty, value);
        }

        // Using a DependencyProperty as the backing store for IsEditable.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty IsRectProperty =
            DependencyProperty.RegisterAttached("IsRect", typeof(Rect), typeof(DragHelperBase), new PropertyMetadata(new Rect(1,1,10,10)));
        #endregion
        #endregion
