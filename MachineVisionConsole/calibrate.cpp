...
int maincannnnnn()
{
	ifstream inImgPath("C:\\Users\\surface laptop\\Documents\\Project\\Demo\\x64\\Release\\calibdata.txt");    //标定所用图像文件的路径
	...
	ofstream fout("C:\\Users\\surface laptop\\Documents\\Project\\Demo\\x64\\Release\\caliberation_result.txt");   //保存标定结果的文件
